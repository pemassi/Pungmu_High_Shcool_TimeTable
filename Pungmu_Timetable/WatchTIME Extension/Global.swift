...
class Webkit {
    ...
    static func GetWebResponetest(urls:String) -> String?
    {
        let urlPath: String = urls
        ...
        do
        {
            ...
            return NSString(data: dataVal, encoding: NSUTF8StringEncoding)!.toString()
        }
        catch
        {
            return nil
    ...
    static func GetWebResponetest2(urls:String) -> String?
    {
        let urlPath: String = urls
        let url: NSURL = NSURL(string: urlPath)!
        let request1: NSMutableURLRequest = NSMutableURLRequest(URL: url)
        ...
        NSURLConnection.sendAsynchronousRequest(request1, queue: NSOperationQueue.mainQueue()) { (response: NSURLResponse?, data: NSData?, error: NSError?) in
            ...
            return_data = string!.toString()
            
            //return string!.toString()
            
        }
        
        print("dqd" + return_data)
        return return_data
    }
}
